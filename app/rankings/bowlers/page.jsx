...
export const metadata = {
  title: "ICC Bowler Rankings - Tests, ODI, T20I | CricketDen",
  description: "Latest ICC bowler rankings for Test cricket, ODI, and T20I formats. View top 10 bowlers rankings updated regularly.",
  keywords: "ICC Rankings, Bowler Rankings, Test Rankings, ODI Rankings, T20I Rankings, Cricket Rankings",
  openGraph: {
    title: "ICC Bowler Rankings - Tests, ODI, T20I | CricketDen",
    description: "Latest ICC bowler rankings for Test cricket, ODI, and T20I formats.",
    url: "https://cricketden.live/rankings/bowlers",
    type: "website",
...
const fetchRankings = async (compType) => {
  const url = `https://assets-icc.sportz.io/cricket/v1/ranking?client_id=tPZJbRgIub3Vua93/DWtyQ==&comp_type=${compType}&feed_format=json&lang=en&type=bowl`;
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
      <div className={`${color} text-white px-6 py-4`}>
        ...
        <p className="text-sm text-white/80">Top 10 Bowlers</p>
      </div>
...
const BowlerRankingsPage = async () => {
...
export default BowlerRankingsPage;
