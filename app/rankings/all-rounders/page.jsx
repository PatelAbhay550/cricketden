...
export const metadata = {
  title: "ICC All-Rounder Rankings - Tests, ODI, T20I | CricketDen",
  description: "Latest ICC all-rounder rankings for Test cricket, ODI, and T20I formats. View top 10 all-rounders rankings updated regularly.",
  keywords: "ICC Rankings, All-Rounder Rankings, Test Rankings, ODI Rankings, T20I Rankings, Cricket Rankings",
  openGraph: {
    title: "ICC All-Rounder Rankings - Tests, ODI, T20I | CricketDen",
    description: "Latest ICC all-rounder rankings for Test cricket, ODI, and T20I formats.",
    url: "https://cricketden.live/rankings/all-rounders",
    type: "website",
...
const fetchRankings = async (compType) => {
  const url = `https://assets-icc.sportz.io/cricket/v1/ranking?client_id=tPZJbRgIub3Vua93/DWtyQ==&comp_type=${compType}&feed_format=json&lang=en&type=allrounder`;
  
  try {
    const res = await fetch(url, { next: { revalidate: 3600 } });
    if (!res.ok) throw new Error('Failed to fetch rankings');
    const data = await res.json();
    return data.data['bat-rank'].rank.slice(0, 10);
  } catch (error) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
      <div className={`${color} text-white px-6 py-4`}>
        ...
        <p className="text-sm text-white/80">Top 10 All-Rounders</p>
      </div>
...
const AllRounderRankingsPage = async () => {
...
export default AllRounderRankingsPage;
